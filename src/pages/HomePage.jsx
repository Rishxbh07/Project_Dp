...
const HomePage = ({ session }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 min-h-screen font-sans relative overflow-hidden">
        ...
        <div className="max-w-md mx-auto px-4">
          ...
          <div className="text-center mb-8 px-4">
            ...
            <div className="flex justify-center gap-3 mt-6">
              {[
                ...
                <div 
                  key={index}
                  className={`bg-gradient-to-br ${stat.color} backdrop-blur-md border border-white/20 rounded-2xl px-4 py-3 transform hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10`}
                >
          ...
          <section className="mt-10">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="text-purple-300 text-sm font-semibold hover:text-purple-200 transition-colors">
                View All
              </button>
            </div>
            ...
            <div className="flex space-x-4 overflow-x-auto pb-4 scrollbar-hide">
              {loading ? (
                ...
                [...Array(3)].map((_, i) => (
                  <div key={i} className="flex-shrink-0 w-[240px] h-[320px] bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 animate-pulse">
                    <div className="w-24 h-24 bg-white/10 rounded-2xl mb-4"></div>
