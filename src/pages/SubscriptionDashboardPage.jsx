    ...
    return (
        <>
            <div className="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans">
                ...
                {/* --- REUSABLE HEADER --- */}
                <PageHeader 
                    title={`${service_name} Family`} 
                    // Default back behavior (navigate -1) handles the back button automatically
                />

                {/* --- Main Content --- */}
                {/* Added pt-20 to ensure content isn't hidden behind the fixed header */}
