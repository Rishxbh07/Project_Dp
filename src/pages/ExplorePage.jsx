...
const ExplorePage = ({ session }) => {
    ...
    const RequestServiceCTA = () => (
        <section className="text-center py-8 mt-8 border-t border-gray-200 dark:border-white/10">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <aside className="lg:col-span-1 lg:sticky lg:top-24 h-fit">
                        <div className="bg-white dark:bg-slate-800/50 p-6 rounded-2xl border border-gray-200 dark:border-white/10 space-y-6">
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white dark:bg-slate-800/50 p-6 rounded-2xl border border-gray-200 dark:border-white/10">
                            {loading && <Loader />}
                            {error && <p className="text-center text-red-500">{error}</p>}
                            {!loading && !error && (
                                <>
                                    <h2 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-4">{selectedCategory} Services</h2>
