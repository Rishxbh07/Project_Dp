      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-900 min-h-screen font-sans text-white">
        ...
        <header className="sticky top-0 z-20 backdrop-blur-xl bg-slate-900/80 border-b border-white/10">
          <div className="max-w-md mx-auto px-4 py-4 flex justify-between items-center">
            <Link to="/subscription" className="text-purple-400 hover:text-purple-300 transition-colors">
              &larr; Back
            </Link>
        ...
        <div className="max-w-md mx-auto px-4 py-6">
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 mb-8 space-y-4">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-slate-400 text-sm">Hosted by</p>
                <p className="text-white font-semibold text-lg">{subscriptionDetails.hostName}</p>
              </div>
              <div className="text-right">
                <p className="text-slate-400 text-sm">Monthly Rate</p>
                <p className="text-purple-300 font-bold text-2xl">₹{subscriptionDetails.rate}</p>
              </div>
            </div>
            <div className="border-t border-white/10"></div>
            <div className="flex justify-between items-center">
              <div>
                <p className="text-slate-400 text-sm">Plan Rating</p>
                <p className="text-white font-semibold flex items-center gap-1">{subscriptionDetails.planRating} <Star className="w-4 h-4 text-yellow-400" fill="currentColor" /></p>
              </div>
              <div className="text-right">
                <p className="text-slate-400 text-sm">Host Rating</p>
                <p className="text-white font-semibold flex items-center gap-1 justify-end">{subscriptionDetails.hostRating} <Star className="w-4 h-4 text-yellow-400" fill="currentColor" /></p>
              </div>
            </div>
             <div className="border-t border-white/10"></div>
             <div className="flex justify-between items-center">
               <div>
                ...
                <p className="text-white font-semibold">{subscriptionDetails.renewalDate}</p>
              </div>
               <div className="text-right">
                <p className="text-slate-400 text-sm">Joined on</p>
                <p className="text-white font-semibold">{subscriptionDetails.joinedDate}</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <button className="w-full text-left bg-white/5 flex items-center p-4 rounded-lg hover:bg-white/10 transition-colors">
              <MessageSquare className="w-5 h-5 mr-4 text-blue-400" />
              <span className="font-semibold">Chat with Host</span>
            </button>
            <button className="w-full text-left bg-white/5 flex items-center p-4 rounded-lg hover:bg-white/10 transition-colors">
              <AlertTriangle className="w-5 h-5 mr-4 text-yellow-400" />
              <span className="font-semibold">Raise an Issue</span>
            </button>
            <button 
            ...
            >
              ...
              <span className="font-semibold text-red-400">Leave Plan</span>
            </button>
          </section>
        </div>
      </div>
      ...
      <Modal isOpen={showLeaveModal} onClose={() => setShowLeaveModal(false)}>
        <div className="text-center">
          ...
          <div className="bg-purple-500/10 border border-purple-400/30 rounded-lg p-3 text-sm mb-6">
            <p className="font-semibold text-purple-300">Rethink Your Life's Stupid Decisions Period</p>
